...
public class BuilderSensorIsTameable extends BuilderSensorBase {
   protected final BooleanHolder value = new BooleanHolder();

   @Nonnull
   public String getShortDescription() {
      return "Whether an entity is tameable or not";
   }
   ...
   public Sensor build(@Nonnull BuilderSupport builderSupport) {
      return new SensorIsTameable(this, builderSupport);
   }
