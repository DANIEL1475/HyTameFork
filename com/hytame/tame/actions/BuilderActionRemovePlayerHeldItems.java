...
public class BuilderActionRemovePlayerHeldItems extends BuilderActionBase {
   ...
   public String getShortDescription() {
      return "Remove held item(s) from the player";
   }
   ...
   public BuilderActionRemovePlayerHeldItems readConfig(@Nonnull JsonElement data) {
      this.getInt(data, "Count", (c) -> this.count = c, 1, IntRangeValidator.fromExclToIncl(0, 100), BuilderDescriptorState.Stable, "The amount of items to remove", (String)null);
      return this;
   }
}
